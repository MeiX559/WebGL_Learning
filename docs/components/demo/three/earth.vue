<template>
  <canvas ref="canvasRef" class="container" width="800" height="800"></canvas>
</template>
...
onMounted(() => {
  new Earth(canvasRef.value, cityList, relationList).load()
})
</script>
<style scoped>
.container {
  width: 100vh;
  height: 100vh;
  background: url('../../earth/images/xingkong.png') no-repeat;
